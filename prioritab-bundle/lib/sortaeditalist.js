...
$(function () {
	...
	var constructToDoCard = function (toDoKey, toDoText) {
		var done = checkIfCompleted(toDoKey) ? "checked" : "",
			...
			borderColorToUse =
				done === "checked" ? "shadow-border-color" : "main-border-color";
		return (
			"<li class='todo-card main-bgcolor " +
			fontColorToUse +
			" " +
			borderColorToUse +
			"' id='" +
			...
			toDoText +
			"</div>" +
			"<div class='pull-right todo-card-right'><a href='#' class='main-font-color'><i class='far fa-trash-alt' title='Delete'></i></a></div>" +
			"</li>"
		);
	};
	...
	$(".shown-items").on("change", "input[type=checkbox]", function () {
		...
		if ($(this).is(":checked") === true) {
			$(this)
				.parent()
				.parent()
				.addClass("shadow-color")
				.addClass("shadow-border-color")
				.removeClass("main-font-color")
				.removeClass("main-border-color");
			...
			$(this)
				...
				.addClass("main-border-color")
				.removeClass("shadow-color")
				.removeClass("shadow-border-color");
			$(this)
				.parent()
				.parent()
				.find(".todo-text")
				.removeClass("todo-card-done");
